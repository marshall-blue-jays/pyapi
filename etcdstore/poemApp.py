...
def main():
    ...
    while True:
        ...
        if userinput == "1":
            ...
            poemslist = getpoems()
            ## Test what was poemslist?
            if poemslist:
                print()
                for poem in poemslist:
                    print(f"Poem ID - {poem}")
            else:  ## if poemlist() returned FALSE
                print("There are no poems to read.")
            
        ## user wants to read a specific poem
        elif userinput == "2":
        ...
        ## user wants to exit
            ...
            deleteallpoems()
            print("All poems have been removed from the system")

        ## user inputs a non valid option
        else:
            print("That is not a valid option")

    print("Thanks for providing your poems.")
